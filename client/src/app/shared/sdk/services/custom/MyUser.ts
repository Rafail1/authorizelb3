...
export class MyUserApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public resend(email: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/myUsers/resend";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public getMyRole(req: any = {}, res: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/myUsers/getMyRole";
    let _routeParams: any = {};
   ...
   * </em>
   */
  public resetPasswordSend(email: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/myUsers/resetPasswordSend";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof email !== 'undefined' && email !== null) _urlParams.email = email;
   ...
   * </em>
   */
  public resetMyPassword(options: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/myUsers/resetMyPassword";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
